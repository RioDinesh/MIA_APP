...
class Event_Readme extends StatefulWidget {
  final EventData eventData;
  Event_Readme({@required this.eventData});

  @override
  _Event_ReadmeState createState() => _Event_ReadmeState();
}

class _Event_ReadmeState extends State<Event_Readme> {
  @override
                      ...
                      crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          ...
                          Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              image: DecorationImage(
                                image: NetworkImage(ApiBase.imgblog+widget.eventData.eventImage),
                                fit: BoxFit.cover
                              )
                            ),
                          ),
                          SizedBox(height: 10.h,),
                              ...
                              Text("Author : "+widget.eventData.eventAuthor,style: TextStyle(fontFamily: "Nunito-Bold",fontSize: 14.sp,color: MainColor),),
                              Text("Date : "+widget.eventData.createdAt.substring(0,11),style: TextStyle(fontFamily: "Nunito-Light",fontSize: 12.sp,color: MainColor),)
                    ...
                    child: Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          child: Text(widget.eventData.eventTitle,style: TextStyle(fontFamily: "Nunito-Bold",fontSize: 18.sp),)),
                      
                 SizedBox(
                       height: 10.h,
                 ),
                      Text(widget.eventData.description,style: TextStyle(fontFamily: "Nunito-Light"),),
                        ],
                      ),
                    ),
                  ),
