...
class News_Readme extends StatefulWidget {
  NewsData newsData;
  News_Readme({@required this.newsData});

  @override
  _News_ReadmeState createState() => _News_ReadmeState();
}

class _News_ReadmeState extends State<News_Readme> {
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text("News",style: TextStyle(fontFamily: "Nunito-Regular",color: Colors.black),),
      ),
      body: SafeArea(
        child: Container(
                      ...
                      crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          ...
                          Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              image: DecorationImage(
                                image: NetworkImage(ApiBase.imgblog+widget.newsData.newsImage),
                                fit: BoxFit.cover
                              )
                            ),
                          ),
                          SizedBox(height: 10.h,),
                              ...
                              Text("Author : "+widget.newsData.newsAuthor,style: TextStyle(fontFamily: "Nunito-Bold",fontSize: 14.sp,color: MainColor),),
                              Text("Date : "+widget.newsData.createdAt.substring(0,11),style: TextStyle(fontFamily: "Nunito-Light",fontSize: 12.sp,color: MainColor),)
                    ...
                    child: Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          child: Text(widget.newsData.newsTitle,style: TextStyle(fontFamily: "Nunito-Bold",fontSize: 18.sp),)),
                      
                 SizedBox(
                       height: 10.h,
                 ),
                      Text(widget.newsData.description,style: TextStyle(fontFamily: "Nunito-Light"),),
                        ],
                      ),
                    ),
                  ),
